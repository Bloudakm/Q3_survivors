...
public class RoutePlanner
{
    ...
    public (List<Node1> path, List<(string label, (int x, int y) pos)> stops)? FindBestPath((int x, int y) start, List<Passenger> passengers)
    {
